...
public class SelectSpaceShipScreen extends Panel{
	...
	private JPanel createCenterPanel() {
		...
		JButton btnspaceShipZero=new JButton("SZERO"); 
	...
	class SpaceShipSelectionBtnHandler implements ActionListener {
			...
			public void actionPerformed(ActionEvent ev){
				...
				if(name.equalsIgnoreCase("SZERO"))SpaceFrame.gamePlayScreen.intGame(new SpaceShipZERO());
				if(name.equalsIgnoreCase("SALPHA")) SpaceFrame.gamePlayScreen.intGame(new SpaceShipALPHA());
				if(name.equalsIgnoreCase("SBETA"))SpaceFrame.gamePlayScreen.intGame(new SpaceShipBETA());
				if(name.equalsIgnoreCase("SGAMA"))SpaceFrame.gamePlayScreen.intGame(new SpaceShipGAMA());
				if(name.equalsIgnoreCase("SDELTA"))SpaceFrame.gamePlayScreen.intGame(new SpaceShipDELTA());
